...
test.beforeEach(async ({ page }) => {
  await page.goto('/')
  pom = new PageManager(page) // with this we have added all the imports in POM Manager. SO, no need to write const multiple times
...
test('Parametrized page Object methods', async ({ page }) => {
  ...
  await navigateTo.formLayoutsPage()
  await formLayoutsPage.submitUsingTheGridForm('armtest@gmail.com', 'Test@123', 'Option 2')
